...
def get_customer_metrics(company_identifier: str) -> str:
    ...
    Returns a JSON string containing the columns defined in the environment configuration.
...
{os.environ.get('AGENT_ROLE', 'You are an enterprise data analyst.')}
{os.environ.get('AGENT_OBJECTIVE', 'Analyze the data provided by your tools.')}
...
3. Synthesize the data you gather to fulfill your objective.
"""

# The instantiated agent ready for import by other scripts or deployment engines
